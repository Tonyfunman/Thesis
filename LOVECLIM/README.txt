...
In order to get all the figures used in the paper generated, please run Post_Trait_Mult_Freq.py. Make sure you have the 18GB 'data' directory, it contains all the netCDF files used in the evaluation.
